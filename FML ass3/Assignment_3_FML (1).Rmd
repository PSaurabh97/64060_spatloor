...
```
```{r}
accidents <- read.csv("C:/Users/patlo/Downloads/accidentsFull.csv")
...
Using Bayes' Theorem, the formula is as follows:

P(I = Yes | W = 1, T = 1) = [P(W = 1 | I = Yes) * P(T = 1 | I = Yes) * P(I = Yes)] / [P(W = 1 | I = Yes) * P(T = 1 | I = Yes) * P(I = Yes) + P(W = 1 | I = No) * P(T = 1 | I = No) * P(I = No)]

Where:

P(I = Yes) is the prior probability of an injury occurring.
P(I = No) is the prior probability of no injury.
P(W = 1 | I = Yes) is the probability of the weather condition being 1 given that there is an injury.
P(W = 1 | I = No) is the probability of the weather condition being 1 given that there is no injury.
P(T = 1 | I = Yes) is the probability of the traffic condition being 1 given that there is an injury.
P(T = 1 | I = No) is the probability of the traffic condition being 1 given that there is no injury.
